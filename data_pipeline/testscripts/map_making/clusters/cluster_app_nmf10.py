...
in_file = open('data/clustergeo_nmf20.json','r')
...
def map():
    ...
    return render_template("cluster_nmf10.html", sf_cong_113 = sf_cong_113, api_key = api_key)

if __name__ == '__main__':
    app.run(host='127.0.0.1', port=6978, debug=True)
